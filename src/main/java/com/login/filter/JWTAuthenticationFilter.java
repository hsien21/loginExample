...
//		String headerString = request.getHeader(JwtUtil.AUTHORIZATION);
//		JSONObject json = new JSONObject();
//
//		// 跳过不需要验证的路径
//		if (null != SecurityConfig.AUTH_WHITELIST && Arrays.asList(SecurityConfig.AUTH_WHITELIST).contains(urlString)) {
//			chain.doFilter(request, response);
//			return;
//		}
//
//		if (StringUtils.isBlank(headerString) || !headerString.startsWith(JwtUtil.TOKEN_PREFIX)) {
//
